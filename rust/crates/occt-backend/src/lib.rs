...
impl GeometryBackend for OcctBackend{
 ...
 fn fuse(&self,left:&Self::Shape,right:&Self::Shape,t:ToleranceContext)->Result<GeometryResult<Self::Shape>,GeometryError>{self.boolean(left,right,t,unsafe{umlcad_occt_fuse})}
 fn common(&self,left:&Self::Shape,right:&Self::Shape,t:ToleranceContext)->Result<GeometryResult<Self::Shape>,GeometryError>{self.boolean(left,right,t,unsafe{umlcad_occt_common})}
 fn cut(&self,left:&Self::Shape,right:&Self::Shape,t:ToleranceContext)->Result<GeometryResult<Self::Shape>,GeometryError>{self.boolean(left,right,t,unsafe{umlcad_occt_cut})}
