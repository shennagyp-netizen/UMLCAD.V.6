...
mod tests {
    ...
    #[test] fn surface_offset_rejects_non_orthogonal_parameter_directions() { let patch=PlanarSurfacePatch3D{origin:Point3{x:0.,y:0.,z:0.},u_dir:Point3{x:1.,y:0.,z:0.},v_dir:Point3{x:0.7071067811865476,y:0.7071067811865476,z:0.},width:1.,height:1.}; assert_eq!(patch.validate(tolerance()),Err(GeometryError::InvalidInput("planar surface directions must be orthogonal"))); }
