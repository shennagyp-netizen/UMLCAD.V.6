...
fn quadratic() -> BSplineCurve2D {
    BSplineCurve2D::new(2, vec![p(0.0, 0.0), p(1.0, 1.0), p(2.0, 0.0)], vec![0.0, 0.0, 0.0, 1.0, 1.0, 1.0])
}
...
fn repeated_internal_knot_is_supported_without_breaking_the_curve_domain() {
    let curve = BSplineCurve2D::new(2, vec![p(0.0, 0.0), p(1.0, 2.0), p(2.0, -1.0), p(3.0, 0.0), p(4.0, 1.0)], vec![0.0, 0.0, 0.0, 0.5, 0.5, 1.0, 1.0, 1.0]);
